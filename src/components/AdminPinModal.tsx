            ...
            {adminTab === 'manage_rights' && (
              <div>
                <div style={{ padding: '10px 12px', borderRadius: '8px', background: '#FFFBEB', border: '1px solid #FDE68A', marginBottom: '12px', fontSize: '0.78rem', color: '#92400E', lineHeight: 1.4 }}>
                  👑 <strong>Root Controls (Flat 302 - Kamesh):</strong> Grant or revoke Admin editing rights for each flat. Flat owners with Admin access can log payments & expenses. Tenants receive read-only access.
                </div>
